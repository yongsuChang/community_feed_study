...
public class Comment {
    ...
    public static Comment createComment(Long id, Post post, User author, String contentText) {
        return new Comment(id, post, author, new CommentContent(contentText));
    }
    ...
    public Content getCommentObject() {
        return content;
    }
}
